...
@Entity
@Table(name = "svpa")
public class Svpa implements DomainObject {
	...
	private List<MovimentacaoSvpa> movimentacoes;
	private List<QtdServicoSvpa> qtdServicos;
	private List<OcorrenciaSvpa> ocorrencias;
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "SvpaIdGenerator")
	@GenericGenerator(name = "SvpaIdGenerator", strategy = "br.com.csl.lynx.generator.SvpaIdGenerator")
	public Long getId() {
		return id;
	}
	...
	@BatchSize(size = 500)
	@OrderBy("id ASC")
	@OneToMany(mappedBy = "svpa", cascade = CascadeType.ALL, fetch=FetchType.EAGER)
	public List<MovimentacaoSvpa> getMovimentacoes() {
		return movimentacoes;
	}

	public void setMovimentacoes(List<MovimentacaoSvpa> movimentacoes) {
	...
	@JoinTable(name = "svpa_qtdservico")
	public List<QtdServicoSvpa> getQtdServicos() {
		return qtdServicos;
	}

	public void setQtdServicos(List<QtdServicoSvpa> qtdServicos) {
	...
	@OrderBy("id ASC")
	@OneToMany(mappedBy = "svpa", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	public List<OcorrenciaSvpa> getOcorrencias() {
		return ocorrencias;
	}
	
	public void setOcorrencias(List<OcorrenciaSvpa> ocorrencias) {
