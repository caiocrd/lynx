...
@Entity
@Table(name = "qtdservicoSiep")
public class QtdServicoSiep implements DomainObject {
	...
	@ManyToOne
	@JoinTable(name = "siep_qtdservico", joinColumns = { @JoinColumn(name = "qtdservicos_id")}, inverseJoinColumns = { @JoinColumn(name = "siep_id")})
	public Siep getSiep() {
		return siep;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QtdServicoSiep other = (QtdServicoSiep) obj;
		if (id == null) {
			if (other.id != null)
				return false;
