...
public abstract class RegionSiepAbstractController extends AbstractSiepAction {
	...
	public RegionSiepAbstractController() {
	...
	public void toAdequate() {
		try {
			movementHandler.evaluate(siep);
			movementHandler.toAdequate(siep, obs, fotoHandler.getMovFolder());
	...
	public void done() {
		try {
			movementHandler.evaluate(siep);
			movementHandler.done(siep, obs, fotoHandler.getMovFolder());
