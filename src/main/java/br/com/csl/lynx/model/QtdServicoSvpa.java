...
@Entity
@Table(name = "qtdservicoSvpa")
public class QtdServicoSvpa implements DomainObject {
	...
	@ManyToOne
	@JoinTable(name = "svpa_qtdservico", joinColumns = { @JoinColumn(name = "qtdservicos_id")}, inverseJoinColumns = { @JoinColumn(name = "svpa_id")})
	public Svpa getSvpa() {
		return svpa;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QtdServicoSvpa other = (QtdServicoSvpa) obj;
		if (id == null) {
			if (other.id != null)
				return false;
