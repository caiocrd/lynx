...
@ManagedBean
@ViewScoped
public class CancelSvpaController extends AbstractSvpaAction {

	private static final long serialVersionUID = 1L;
	
	public CancelSvpaController() {
	...
	public void cancel() {
		try {
			movementHandler.cancel(svpa, obs);
			
			clear();
			addFacesInfoMessage("Svpa cancelada com sucesso.");
